<?php
/*
Template Name: Categoria - Fondos Oscuros
*/
?>
			...
			<div id="main" class="fullcol first clearfix" role="main"> <!-- Contenedor Principal -->
				...
				<div id="inner-content" class="wrap clearfix">	<!-- Contenedor Interno -->						
					...
					<!-- Comienzan Llamado de Posts -->
						...
						<div class="contenedor-post-individual2">
								...
								<?php
									...
									if (have_posts()) : while (have_posts()) : the_post(); ?>																		
										...
										<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> role="article">
											...
											<div class="imagen-post-individual2 first unodedos-a">
											
												<?php the_post_thumbnail('bones-thumb-900', array('class' => 'alignleft')); ?>
											
											</div>

														
											<div class="titulo-post-individual2 dosdedos-a">
											
												<h3 class="h2"><?php the_title(); ?></h3> 
											
											</div>

											<div class="fecha-post-individual2 dosdedos-a">
											
												<p ><?php the_time('j F Y')?></p>
											
											</div>

											<div class="contenido-post-individual2 dosdedos-a">
