...
?>
			...
			<div id="main" class="fullcol clearfix" role="main"> <!-- Contenedor Principal -->

				<h1> ¡Gracias por participar en la 3ra Olimpiada de Lectura! </h1>

				<h2> Espera las actividades a partir del 18 de noviembre. </h2>
