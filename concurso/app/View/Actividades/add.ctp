...
<div style="float:left; width: 25%;">
    <?php
    echo $this->Form->create('Actividad',array('url'=>array('controller'=>'actividades','action'=>'save')));
    ...
    echo $this->Form->input('Actividad.no_evidencias',array('disabled'=>'disabled','label'=>'Número de evidencias: ','type'=>'text'));
    ?>
</div>
<div class="cargaEvidencias">
    <?php 
    for($i = 0; $i <= $this->data['Actividad']['no_evidencias'] - 1; $i++){
        ?>
        <div style="float:left; width: 25%;">
            <?php
